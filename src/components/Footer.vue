  ...
  <footer class="md:w-full h-[500px] relative" style="background:#252525;">
   <div class="container mx-auto grid md:grid-cols-2 grid-cols-1 gap-4 items-center h-full">
    <div>
        ...
        <ul class="flex gap-4 mt-8 items-center">
            <li class="bg-white w-8 h-8 rounded-full">
                <RouterLink class="text-red-500" to="#">
            ...
            <li class="bg-white w-5 h-5 rounded-full scale-150">
                <RouterLink to="#">
